...
MESH_PATH = os.path.join(ROOT_DIR, 'meshes', 'pattern_01_2_lines_angle_1_2.obj')
RECON_PATH = os.path.join(ROOT_DIR, 'renders', 'gt_reconstruction.ply')

session_dirs = sorted([
    d for d in os.listdir(os.path.join(ROOT_DIR, 'renders'))
    if d.startswith('session_')
])
session_path = os.path.join(ROOT_DIR, 'renders', session_dirs[0], 'session.json')
